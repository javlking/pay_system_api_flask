...
Revision ID: 269deb473481
Revises: 
Create Date: 2023-02-24 21:00:11.754227
...
def upgrade():
    ...
    sa.Column('opened', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['business_card'], ['cards.card_number'], ondelete='SET NULL'),
